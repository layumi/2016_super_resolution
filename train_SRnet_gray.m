...
opts.train.expDir = '/home/zzd/super-resolution/data/SRnet-128-gray' ; 
opts.train.learningRate = [1e-5*ones(1,5) 1e-6*ones(1,2)];
...
img = zeros(128,128,1,batch_size,'single');
