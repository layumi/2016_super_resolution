...
net.layers{end+1} = struct('type', 'conv', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'relu','leak',0.1) ;
net.layers{end+1} = struct('type','dropout','rate',0.75);
% Block 5
net.layers{end+1} = struct('type', 'conv', ...
...
net.meta.trainOpts.learningRate = [0.05*ones(1,100) 0.005*ones(1,20) 0.0005*ones(1,10)] ;
net.meta.trainOpts.weightDecay = 0.0001 ;
net.meta.trainOpts.batchSize = 100 ;
net.meta.trainOpts.numEpochs = numel(net.meta.trainOpts.learningRate) ;
net.meta.trainopts.gpus=[2,3];
net.meta.trainopts.continue=false;
