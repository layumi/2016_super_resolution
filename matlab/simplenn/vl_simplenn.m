...
for i=1:n
  ...
  switch l.type
    ...
    case 'softmaxloss_label_smooth'
      res(i+1).x = vl_nnsoftmaxloss_label_smooth(res(i).x, l.class) ;
...
if doder
  ...
  for i=n:-1:max(1, n-opts.backPropDepth+1)
    ...
    switch l.type
      ...
      case 'softmaxloss_label_smooth'
        res(i).dzdx = vl_nnsoftmaxloss_label_smooth(res(i).x, l.class, res(i+1).dzdx) ;
